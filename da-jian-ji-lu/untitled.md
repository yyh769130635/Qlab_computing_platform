...
### [准备部署环境](https://github.com/microsoft/pai/blob/master/docs/zh_CN/pai-management/doc/distributed-deploy.md%22%20/l%20%22c-step-1)
...
集群的信息在配置文件中进行修改，首先，在/pai/development/quick-start文件夹中，我们 使用vim命令修改quick-start.yaml文件。
