...
[**1 项目简介** ](spark.md#xiang-mu-jian-jie)\*\*\*\*

[**2 Spark搭建**](spark.md#2spark-da-jian) ****

\*\*\*\*[**3 Hive安装**](spark.md#3hive-an-zhuang) 

\*\*\*\*[**4 Mysql安装**](spark.md#4mysql-an-zhuang)  

\*\*\*\*[**5 Hive && spark**](spark.md#5-hive-and-and-spark) 

\*\*\*\*[**6 计算平台验证**](spark.md#6-ji-suan-ping-tai-yan-zheng) 

\*\*\*\*[**7 参考资料** ](spark.md#can-kao-zi-liao)\*\*\*\*
